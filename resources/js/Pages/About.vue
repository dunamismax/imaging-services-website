...
<template>
    <SiteLayout>
        ...
        <section class="mx-auto mt-10 max-w-7xl px-4 lg:px-8">
            ...
            <h1 class="mt-4 font-display text-4xl font-semibold text-brand-deep md:text-5xl">Our dedicated team caters to your business</h1>
        ...
        <section class="mx-auto mt-10 max-w-7xl px-4 lg:px-8">
            <div class="mb-5">
                ...
                <h2 class="mt-3 font-display text-3xl font-semibold text-brand-deep">People behind your imaging operations</h2>
            </div>
