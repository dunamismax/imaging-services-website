...
This repository contains the Laravel 12 / Livewire 4 rebuild of the Imaging Services USA website. It is designed for fast content updates, reliable form handling, and complete route coverage for the company’s public pages and media posts.

## Trust Signals

![PHP](https://img.shields.io/badge/PHP-8.4%2B-777BB4?logo=php&logoColor=white)
![Laravel](https://img.shields.io/badge/Laravel-12.x-FF2D20?logo=laravel&logoColor=white)
![Livewire](https://img.shields.io/badge/Livewire-4.x-4E56A6)
...
- Full-page Livewire routes for all public sitemap slugs (home, equipment, services, accessories, contact, payments, privacy, media, and marketing pages).
...
| UI | [Livewire 4](https://livewire.laravel.com/docs/4.x/quickstart) | Full-page and interactive form components |
...
```sh
imaging-services-website/
├── app/Livewire/Pages/                 # Full-page Livewire components (site pages)
├── app/Livewire/Forms/                 # Interactive Livewire form components
...
├── resources/views/livewire/pages/     # Blade templates for page components
├── resources/views/livewire/forms/     # Blade templates for form components
├── resources/css/app.css               # Tailwind + custom site theme styles
├── routes/web.php                      # Public route definitions and slug mappings
├── tests/Feature/                      # Route coverage + Livewire form behavior tests
...
php artisan test --compact tests/Feature/LivewireFormsTest.php
```
...
- Public form inputs are validated server-side in Livewire actions before processing.
- Form submissions are rate-limited per IP via `RateLimiter` in `app/Livewire/Forms/Concerns/ThrottlesSubmissions.php`.
...
| Path | Purpose |
|---|---|
| [AGENTS.md](AGENTS.md) | Repository-specific working rules and Laravel/Livewire agent guidance |
| [Agent-Context.md](Agent-Context.md) | Rebuild handoff context and source-priority notes |
| [config/site_content.php](config/site_content.php) | Source-of-truth content map used by routes and Livewire pages |
...
| [tests/Feature/LivewireFormsTest.php](tests/Feature/LivewireFormsTest.php) | Form validation and submission behavior tests |
