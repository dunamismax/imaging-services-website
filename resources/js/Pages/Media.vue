...
const articleCount = computed(() => orderedPosts.value.length);
</script>
    ...
    <SiteLayout>
            ...
            <div class="surface-card grid gap-6 p-6 md:p-8 lg:grid-cols-12">
                ...
                <div class="lg:col-span-3">
                    <div class="rounded-2xl border border-brand-ink/10 bg-site-panel p-5">
                        ...
                        <p class="mt-1 section-title text-brand-deep">{{ articleCount }}</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="page-shell page-shell-wide page-section pb-4">
            <div class="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
                <article v-for="post in orderedPosts" :key="post.slug" class="surface-card group flex h-full flex-col p-5">
                    ...
                    <Link :href="post.url" class="mt-4 inline-flex text-sm font-semibold text-brand-accent transition group-hover:translate-x-0.5 hover:text-brand-deep">Read article</Link>
                </article>
            </div>
        </section>
    </SiteLayout>
